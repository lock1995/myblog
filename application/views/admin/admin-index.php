...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg"><a href="">首页</a></strong> / <small>一些常用模块</small></div>
    </div>
        ...
        <div class="am-panel am-panel-default">
          ...
          <div class="am-panel-bd am-collapse am-in am-cf" id="collapse-panel-3">
            <ul class="am-comments-list admin-content-comment">
                ...
                <li class="am-comment">
                  <a href="#"><img src="images/blog2.jpg" alt="" class="am-comment-avatar" width="48" height="48"></a>
                  <div class="am-comment-main">
                    <header class="am-comment-hd">
                      <div class="am-comment-meta"><a href="#" class="am-comment-author">lock</a> 评论于 <time>2016-1-1</time></div>
                    </header>
                    <div class="am-comment-bd"><p>fkljas;fjaasfijefsk</p>
                    </div>
                  </div>
                </li>
            ...
            <ul class="am-pagination am-fr admin-content-pagination">
              <li class="am-disabled" style="cursor: pointer"><a href="#">&laquo;</a></li>
              <li class="am-active"><a href="#">1</a></li>
              <li><a href="#">2</a></li>
              <li><a href="#">3</a></li>
              <li><a href="#">4</a></li>
              <li><a href="#">5</a></li>
              <li><a href="#" style="cursor: pointer">&raquo;</a></li>
            </ul>
          </div>
        </div>
