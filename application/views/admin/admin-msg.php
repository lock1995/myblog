                ...
                <td>
                  <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                      ...
                      <button data-id="<?php echo $message -> message_id; ?>" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span> 删除</button>
                    </div>
                  </div>
                </td>
              </tr>
 ...
 $(function(){
   $('.am-btn').on('click', function(){
     ...
     if(confirm('确定是否删除记录，不可恢复!?')){
       location.href = 'admin/delete_msg?msg_id='+messageId;
     }
   });
 });
</script>
